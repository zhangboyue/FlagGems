...
class Benchmark:
    def __init__(
        ...
        self.arg_func_map = {
            ...
            group_norm_args: "group_norm_args",
            masked_fill_args: "masked_fill_args",
            index_select_args: "index_select_args",
        }
...
def index_select_args(dtype, batch, size):
    ...
    index = torch.randint(0, index_size, [floor(index_size * threshold)], device="cuda")
